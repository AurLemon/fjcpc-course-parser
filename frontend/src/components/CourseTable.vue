...
<template>
  ...
  >
    <!-- 周选择器 -->
    <div
      class="border-b-[0.5px] border-gray-200 dark:border-gray-800 p-4 bg-gradient-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-900"
    >
      <div class="flex items-center gap-2 overflow-x-auto pb-2">
        <span
          class="text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap mr-2 font-medium"
          >选择周次:</span
        >
    ...
    <div class="p-4 flex-1 min-h-0">
      <div class="w-full sm:w-full sm:min-w-[740px]">
        ...
        <div class="grid grid-cols-8 gap-2 sm:gap-3 mb-3 timetableHeader">
          <div
            class="text-center text-sm font-semibold text-gray-600 dark:text-gray-300 py-3 bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl"
          >
            节次
          </div>
          <div
        ...
        >
          ...
          <template v-for="courseNum in 10" :key="courseNum">
            ...
            >
              ...
              <div
                class="text-[10px] text-gray-600 mt-1 text-center leading-tight"
              >
          ...
          >
            ...
            <div class="p-6 space-y-4">
              ...
              <div class="flex items-start gap-3">
                <div
                  class="w-10 h-10 rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center flex-shrink-0"
                >
                  <svg
            ...
            <!-- 底部 -->
            <div
              class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-t-[0.5px] border-gray-200"
            >
              <button
                @click="closeDialog"
...
/* PC 默认列宽（保持现状） */
.timetableHeader {
  grid-template-columns: minmax(56px, 1fr) repeat(7, minmax(44px, 1fr));
}
.timetableGrid {
  grid-template-columns: minmax(56px, 1fr) repeat(7, minmax(44px, 1fr));
}
